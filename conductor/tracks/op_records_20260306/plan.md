...
- [x] **Task: 验证前端触发逻辑** [74fee2d]
    - [x] 检查部门切换、员工添加、状态修改是否能成功触发后端操作记录更新。
    - [x] 使用浏览器的 Network 面板确认请求流。
- [x] **Task: 适配统计页展示** [d4e2a6]
    - [x] 确保统计页在调用 API 后，能正确处理可能减少的部门列表（即隐藏未操作部门）。
    - [x] 保持 UI 响应式和加载状态的一致性。
